...
class NetworkDataExtract():
    ...
    def insert_data_to_mongodb(self,records:list,database_name:str,collection_name:str):
        try:
            ...
            return "Data pushed to MongoDB successfully"
        except Exception as e:
            raise NetworkSecurityException(e, sys)

if __name__ == "__main__":
    FILE_PATH = "Network_Data\phisingData.csv"
    DATABASE_NAME = "Network_Data"
    COLLECTION_NAME = "phisingData"
    networkobj = NetworkDataExtract()
    records = networkobj.csv_to_json_convertor(file_path=FILE_PATH)
    no_of_records = networkobj.insert_data_to_mongodb(records=records,database_name=DATABASE_NAME,collection_name=COLLECTION_NAME)
    print(no_of_records)
